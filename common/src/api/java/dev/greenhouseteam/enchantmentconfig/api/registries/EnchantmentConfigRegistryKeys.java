...
public class EnchantmentConfigRegistryKeys {
    ...
    public static final ResourceKey<Registry<VariableSerializer<?, ?>>> VARIABLE_SERIALIZER_KEY = ResourceKey.createRegistryKey(EnchantmentConfigUtil.asResource("variable_serializer"));
