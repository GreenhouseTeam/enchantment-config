...
public class EnchantmentConfigRegistries {
    ...
    public static final Registry<VariableSerializer<?, ?>> VARIABLE_SERIALIZER = EnchantmentConfigUtil.getHelper().createRegistry(EnchantmentConfigRegistryKeys.VARIABLE_SERIALIZER_KEY);
}
