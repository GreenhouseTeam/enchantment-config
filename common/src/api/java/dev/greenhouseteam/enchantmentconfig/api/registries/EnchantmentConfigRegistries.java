...
public class EnchantmentConfigRegistries {
    public static final Registry<MapCodec<? extends EnchantmentCondition>> CONDITION_CODEC = EnchantmentConfigUtil.getHelper().createRegistry(EnchantmentConfigRegistryKeys.CONDITION_CODEC_KEY);
